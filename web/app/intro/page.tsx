          ...
          <table className="w-full text-sm">
            ...
            <tbody className="text-gray-300">
              {[
                ...
                ["GET", "/claim/:token", "Resolve claim link to agent info"],
                ["POST", "/claim/:token/verify", "Consume claim link and start verification"],
                ["POST", "/agents/:id/claim/regenerate", "Generate new claim link"],
                ["POST", "/demo/load", "Load demo data (4 agents, 4 questions)"],
